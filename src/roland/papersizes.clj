(ns roland.papersizes)

(declare paper-formats)

(defn paper-parser
  "Takes a paper size or standard format and returns a corresponding PDRectangle. Default is A4."
  ([]
   (paper-parser :a4))
  ...
  #_([size]
     (let [psize (paper-formats size)
           width (-> paper-formats first float)
           height (-> paper-formats last float)]
       (vector width height)))
...
(def paper-formats {
                    ...
                    :a3 [1190.551194 1683.7795457999998]
